"""00_Base_component_v3 - based from 00_Base_Component_v12
adding statement formatter and minor bug fixes from user testing"""
import random
...
# formats users text using their input text and symbol
...
def maori_numbers():
    ...
    for i in num_list:
        ...
        if attempt == i[1]:
            ...
            print(formatter("L", f"Incorrect, the answer was {i[1]}"))
    print()
...
print("To start off could we please get your name and age?")
name = get_name()
age = get_age()
print()
